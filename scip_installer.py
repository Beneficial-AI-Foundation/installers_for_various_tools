...
def update_path_in_shell_config(install_dir):
    """Add SCIP installation directory to PATH in shell configuration."""
    install_dir = Path(install_dir)
    config_file = get_shell_config_file()
    
    # Path export line to add
    path_line = f'export PATH="{install_dir}:$PATH"  # Added by SCIP installer'
    ...
    print(f"Adding SCIP to PATH in {config_file}")
...
def main():
    ...
    parser.add_argument('--install-dir', '-i',
                       help='Installation directory (default: ~/scip)')
